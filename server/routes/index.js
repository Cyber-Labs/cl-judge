...
router.use('/questions', questionsRouter.getReaderQuestions)
router.use('/questions', questionsRouter.getEditorQuestions)
router.use('/questions', questionsRouter.getAllEditors)
router.use('/questions', questionsRouter.getAllReaders)
...
router.use('/questions', questionsRouter.removeReader)
router.use('/questions', questionsRouter.addReader)
...
router.use('/questions', questionsRouter.updateEditorToReader)
