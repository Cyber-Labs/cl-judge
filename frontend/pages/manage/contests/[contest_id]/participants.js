...
import ContestParticipants from '../../../../components/manage/contests/contestParticipants'
...
const Participants = (props) => {
  ...
  return <div>
    ...
    {!isLoading && !error && <ContestParticipants
      contestId={contestId}
...
export default withPrivateRoute(Participants)
