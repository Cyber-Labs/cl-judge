...
export default function adminRoute (WrappedComponent) {
  return class AdminRoute extends Component {
    constructor (props) {
      super(props)
      this.state = {
    ...
    render () {
      ...
      if (!user) {
        ...
        return (
          <Error message="you don't have admin priviledges to access this page" />
        )
      }
